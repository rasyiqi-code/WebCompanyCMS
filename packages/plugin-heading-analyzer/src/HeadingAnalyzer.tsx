...
export const HeadingAnalyzer = () => {
  ...
  useEffect(() => {
    ...
    let entry = frame?.querySelector(`[data-credbuild-entry]`);
    ...
    const frameObserver = new MutationObserver(() => {
      entry = frame?.querySelector(`[data-credbuild-entry]`);
  ...
  return (
    <div className={getClassName()}>
      ...
      >
        ...
        <a href="https://github.com/credbuild/credbuild/blob/main/packages/plugin-heading-analyzer/README.md">
          README
        </a>
        .
      </small>
                      ...
                      typeof props.element == "undefined"
                        ...
                        : (e) => {
                            ...
                            if (el) {
                              ...
                              el.style.outline =
                                "4px solid var(--credbuild-color-rose-06)";
