...
export interface CredBuildRichTextOptions {
  /**
...
export const defaultCredBuildRichTextOptions: Partial<CredBuildRichTextOptions> = {
  textAlign: {
    types: ["heading", "paragraph"],
  },
};

export const CredBuildRichText = Extension.create<CredBuildRichTextOptions>({
  name: "credbuildRichText",
  addExtensions() {
    const extensions = [];

    const options: Partial<CredBuildRichTextOptions> = {
      ...this.options,
