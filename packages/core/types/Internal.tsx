...
export type CredBuildZoneData = {
  contentIds: string[];
  type: ZoneType;
};

export type NodeIndex = Record<string, CredBuildNodeData>;
export type ZoneIndex = Record<string, CredBuildZoneData>;
...
// Plugins can use `useCredBuild` instead of relying on props
