...
import { DefaultRootFieldProps, CredBuildContext } from "./Props";
...
export type WithCredBuildProps<Props> = Props & {
  credbuild: CredBuildContext;
  editMode?: boolean;
};
export type AsFieldProps<Props> = Omit<Props, "children" | "credbuild" | "editMode">;
