...
```sh
npm i @credbuild/field-contentful
```

```jsx
import createFieldContentful from "@credbuild/field-contentful";
...
An object describing which [`filterFields`](https://credbuild.com/docs/api-reference/fields/external#filterfields) to render and pass the result directly to Contentful as [search parameters](https://www.contentful.com/developers/docs/references/content-delivery-api/#/reference/search-parameters).
...
An [External field](https://credbuild.com/docs/api-reference/fields/external) type that loads Contentful [entries](https://contentful.github.io/contentful.js/contentful/10.6.16/types/Entry.html).
